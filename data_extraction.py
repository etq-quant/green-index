...
ids = ['TNB MK Equity', 'YTLP MK Equity', 'SOLAR MK Equity', 'CYP MK Equity', 'JAK MK Equity', 'HSS MK Equity', 'RLEB MK Equity', 'STHB MK Equity', 'SUNVIEW MK Equity',
        'SAMAIDEN MK Equity', 'CITAGLB MK Equity', 'JSB MK Equity', 'MLK MK Equity', 'MNHLDG MK Equity', 'PEKAT MK Equity', 'UZMA MK Equity', 'UEMS MK Equity', 'SDPR MK Equity', 'GENE MK Equity'
        ]
